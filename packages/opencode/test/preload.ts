...
process.env["NC_MIMO_CODE_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["NC_MIMO_CODE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["NC_MIMO_CODE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["NC_MIMO_CODE_DISABLE_DEFAULT_PLUGINS"] = "true"
...
process.env["NC_MIMO_CODE_DB"] = ":memory:"
