...
const experimental = Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKSPACES

Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKSPACES = experimental
})
