...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.NC_MIMO_CODE_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
