export const dict: Record<string, string> = {
  ...
  "tui.tips.config_files":
    "Create {highlight}nc-mimo-code.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/nc-mimo-code/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "NcMimoCode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.nc-mimo-code/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.nc-mimo-code/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "NcMimoCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "NcMimoCode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.nc-mimo-code/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.nc-mimo-code/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent NcMimoCode from reading sensitive files",
  "tui.tips.run": "Use {highlight}ncmimocode run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}ncmimocode --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}ncmimocode run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}ncmimocode serve{/highlight} for headless API access to NcMimoCode",
  "tui.tips.attach_server": "Use {highlight}ncmimocode run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}ncmimocode upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}ncmimocode auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}ncmimocode agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}ncmimocode github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.nc-mimo-code/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}ncmimocode debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with NcMimoCode for curated, tested models",
  ...
  "cli.providers.mimo_free.usage_hint": "No login required — just run ncmimocode. For paid/premium models, choose MiMo browser login instead.",
