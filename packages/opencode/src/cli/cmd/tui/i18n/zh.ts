...
export const dict = {
  ...
  "tui.tips.config_files":
    "创建 {highlight}nc-mimo-code.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/nc-mimo-code/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "NcMimoCode 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.nc-mimo-code/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.nc-mimo-code/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "NcMimoCode 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "NcMimoCode 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.nc-mimo-code/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.nc-mimo-code/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 NcMimoCode 读取敏感文件",
  "tui.tips.run": "用 {highlight}ncmimocode run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}ncmimocode --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}ncmimocode run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}ncmimocode serve{/highlight} 以无头模式提供 NcMimoCode API",
  "tui.tips.attach_server": "用 {highlight}ncmimocode run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}ncmimocode upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}ncmimocode auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}ncmimocode agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opencode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}ncmimocode github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.nc-mimo-code/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}ncmimocode debug config{/highlight} 排查配置问题",
