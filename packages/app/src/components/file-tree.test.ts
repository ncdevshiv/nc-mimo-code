...
beforeAll(async () => {
  ...
  mock.module("@nc-mimo-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nc-mimo-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nc-mimo-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nc-mimo-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
